                        ...
                        <div class="card-body col-lg-6">
                            <form method="post" action="<?= base_url('masterdata/add_siswa') ?>">
                                ...
                                <div class="form-group" id="tempo">
                                    <label for="tempo">Bulan mulai bayar</label>
                                    <input type="date" class="form-control" id="tempo" name="tempo" value="<?= date('Y-m-d', strtotime("2017-07-20")) ?>">
                                    <span class="text-secondary ml-2">bulan mulai bayar digunakan untuk pembayaran spp siswa dari satu semester sesuai tahun pelajaran dengan format dd/mm/yy.</span> <br>
