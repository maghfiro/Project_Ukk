                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <?php if($this->session->userdata('level')=='Admin') : ?>
                                                        <a href="<?= site_url('pembayaran/hapus/') .
                                                         $pem->ID_PEMBAYARAN; ?>" class="btn btn-danger">Hapus</a>
                                                         <?php endif; ?>
                                                        <a href="<?= site_url('user/cetakStruk/') .
                                                         $pem->ID_PEMBAYARAN; ?>" target="_blank" class="btn btn-default">Cetak</a>
                                                         <?php } ?>
                                                    <?php if ($pem->KET == '') : ?>
                                                        <a href="<?= site_url('pembayaran/transaksi/') .
                                                         $pem->ID_PEMBAYARAN; ?>" class="btn btn-primary">Bayar</a>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
